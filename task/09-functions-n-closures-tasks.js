...
function logger(func, logFunc) {
    return function(...args) {
        ...
        const argsFormat = `(${argsAsString.slice(1, argsAsString.length - 1)})`
        const funcName = func.name

        logFunc(funcName + argsFormat + ' starts')
        const res = func(...args)
        logFunc(funcName + argsFormat + ' ends')
